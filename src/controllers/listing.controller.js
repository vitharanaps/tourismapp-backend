...
export async function getListingById(req, res) {
  try {
    ...
    const result = await pool.query(
      `SELECT l.*, b.name as business_name, b.description as business_description, b.city as business_city, b.phone as business_phone, b.email as business_email, c.name as category_name
             FROM listings l 
